...
public class AutorController {
    ...
    @GetMapping("/{id}")
    public Optional<Autor> findById(@PathVariable String id){return service.findById(id);}

    @PostMapping()
    public Autor save (@RequestBody Autor autor){return service.save(autor);}

    @PutMapping("/{id}")
    public void update (@RequestBody Autor autor, @PathVariable String id) {service.update(autor,id);}
